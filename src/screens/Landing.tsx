        ...
        <div className="container relative">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight">
              Secure Payments for <span className="text-primary">Freelance Services</span>
            </h1>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Protect your transactions with our escrow service. We hold funds safely until the work
              is done, ensuring trust between clients and freelancers.
            </p>
